...
/obj/machinery/proc/default_pry_open(obj/item/I)
	. = !(state_open || panel_open || is_operational || (flags_1 & NODECONSTRUCT_1)) && (QUALITY_PRYING in I.tool_qualities)
	if(.)
...
/obj/machinery/proc/default_deconstruction_crowbar(obj/item/I, ignore_panel = 0)
	. = (panel_open || ignore_panel) && !(flags_1 & NODECONSTRUCT_1) && (QUALITY_PRYING in I.tool_qualities)
	if(.)
		I.play_tool_sound(src, 50)
		deconstruct(TRUE)
...
/obj/machinery/proc/default_deconstruction_screwdriver(mob/user, icon_state_open, icon_state_closed, obj/item/I)
	if(!(flags_1 & NODECONSTRUCT_1) && (QUALITY_SCREW_DRIVING in I.tool_qualities))
		I.play_tool_sound(src, 50)
		if(!panel_open)
			panel_open = TRUE
...
/obj/machinery/proc/default_change_direction_wrench(mob/user, obj/item/I)
	if(panel_open && (QUALITY_BOLT_TURNING in I.tool_qualities))
		I.play_tool_sound(src, 50)
		setDir(turn(dir,-90))
...
/obj/proc/default_unfasten_wrench(mob/user, obj/item/I, time = 20) //try to unwrench an object in a WONDERFUL DYNAMIC WAY
	if(!(flags_1 & NODECONSTRUCT_1) && (QUALITY_BOLT_TURNING in I.tool_qualities))
