...
/obj/structure/windoor_assembly/attackby(obj/item/W, mob/user, params)
	...
	switch(state)
		if("01")
			if((QUALITY_WELDING in W.tool_qualities) && !anchored)
			...
			if((QUALITY_BOLT_TURNING in W.tool_qualities) && !anchored)
			...
			else if((QUALITY_BOLT_TURNING in W.tool_qualities) && anchored)
