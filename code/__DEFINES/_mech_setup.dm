...
GLOBAL_LIST_INIT(mech_weapon_overlays, icon_states('modular_pentest/modules/bay_mech/icons/mech_weapon_overlays.dmi'))
...
#define MECH_COMPONENT_DAMAGE_DESTORYED 5
...
#define CAN_BE_PAINTED "can be painted"
