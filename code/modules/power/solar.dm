...
/obj/machinery/power/solar/proc/set_control(obj/machinery/computer/solar_control/SC)
	unset_control()
	control = SC
...
/obj/item/solar_assembly/attackby(obj/item/W, mob/user, params)
	if((QUALITY_BOLT_TURNING in W.tool_qualities) && isturf(loc))
		if(isinspace())
...
/obj/machinery/computer/solar_control/LateInitialize()
	connect_to_network()
	set_panels(azimuth_target)
	return ..()

/obj/machinery/computer/solar_control/Destroy()
...
/obj/machinery/computer/solar_control/ui_data()
	var/data = list()
...
/obj/machinery/computer/solar_control/ui_act(action, params)
	. = ..()
	if(.)
		return
	if(action == "azimuth")
...
/obj/machinery/computer/solar_control/proc/timed_track()
	SIGNAL_HANDLER
...
/obj/machinery/computer/solar_control/proc/set_panels(azimuth)
