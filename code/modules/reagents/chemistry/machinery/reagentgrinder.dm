...
/obj/machinery/reagentgrinder
	...
	var/static/radial_eject = image(icon = 'icons/hud/radial/menu.dmi', icon_state = "radial_eject")
	var/static/radial_grind = image(icon = 'icons/hud/radial/menu.dmi', icon_state = "radial_grind")
	var/static/radial_juice = image(icon = 'icons/hud/radial/menu.dmi', icon_state = "radial_juice")
	var/static/radial_mix = image(icon = 'icons/hud/radial/menu.dmi', icon_state = "radial_mix")
