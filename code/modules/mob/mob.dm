 ...
 *
 * This will update a mob's name, real_name, mind.name, SS data_core records, pda, id and traitor text
 *
...
///Updates SS data_core records with new name , see mob/living/carbon/human
