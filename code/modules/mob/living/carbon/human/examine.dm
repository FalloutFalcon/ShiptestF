	...
	if(perpname && (HAS_TRAIT(user, TRAIT_SECURITY_HUD) || HAS_TRAIT(user, TRAIT_MEDICAL_HUD)))
		...
		if(target_record)
			...
			if(HAS_TRAIT(user, TRAIT_MEDICAL_HUD))
				. += "<a href='byond://?src=[REF(src)];hud=m;p_stat=1'>\[[target_record.fields[DATACORE_PHYSICAL_HEALTH]]\]</a>"
				. += "<a href='byond://?src=[REF(src)];hud=m;m_stat=1'>\[[target_record.fields[DATACORE_MENTAL_HEALTH]]\]</a>"
		...
		if(HAS_TRAIT(user, TRAIT_MEDICAL_HUD))
			. += "<br><a href='byond://?src=[REF(src)];hud=m;evaluation=1'>\[Medical Evaluation\]</a>"
			. += "<a href='byond://?src=[REF(src)];hud=m;quirk=1'>\[See traits\]</a>"
			var/cyberimp_detect
