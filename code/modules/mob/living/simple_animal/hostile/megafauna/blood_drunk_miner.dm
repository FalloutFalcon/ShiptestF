...
/mob/living/simple_animal/hostile/megafauna/blood_drunk_miner
	...
	loot = list(/obj/item/melee/trick/cleaving_saw, /obj/item/gun/energy/kinetic_accelerator)
	wander = FALSE
	del_on_death = TRUE
	...
	var/obj/item/melee/trick/cleaving_saw/miner/miner_saw
...
/obj/item/melee/trick/cleaving_saw/miner //nerfed saw because it is very murdery
	force = 6
	active_force = 10
