...
/datum/preferences/proc/load_character(slot)
	...
	features[FEATURE_BODY_SIZE]				= sanitize_inlist(features[FEATURE_BODY_SIZE], GLOB.body_sizes, "Normal")
	features[FEATURE_MUTANT_COLOR]					= sanitize_hexcolor(features[FEATURE_MUTANT_COLOR])
	features[FEATURE_MUTANT_COLOR2]					= sanitize_hexcolor(features[FEATURE_MUTANT_COLOR2])
	...
	features[FEATURE_LEGS_TYPE]		= sanitize_inlist(features[FEATURE_LEGS_TYPE], GLOB.legs_list, "Normal Legs")
	...
	features[FEATURE_IPC_CHASSIS]				= sanitize_inlist(features[FEATURE_IPC_CHASSIS], GLOB.ipc_chassis_list)
	features[FEATURE_IPC_BRAIN]				= sanitize_inlist(features[FEATURE_IPC_BRAIN], GLOB.ipc_brain_list)
	...
	features[FEATURE_FLAVOR_TEXT]				= sanitize_text(features[FEATURE_FLAVOR_TEXT], initial(features[FEATURE_FLAVOR_TEXT]))
...
/datum/preferences/proc/save_character()
	...
	WRITE_FILE(S["body_size"]					, features[FEATURE_BODY_SIZE])
	WRITE_FILE(S["prosthetic_limbs"]			, prosthetic_limbs)
	WRITE_FILE(S["feature_mcolor"]				, features[FEATURE_MUTANT_COLOR])
	WRITE_FILE(S["feature_mcolor2"]				, features[FEATURE_MUTANT_COLOR2])
	...
	WRITE_FILE(S["feature_lizard_legs"]			, features[FEATURE_LEGS_TYPE])
	...
	WRITE_FILE(S["feature_ipc_chassis"]			, features[FEATURE_IPC_CHASSIS])
	WRITE_FILE(S["feature_ipc_brain"]			, features[FEATURE_IPC_BRAIN])
	...
	//Flavor text
	WRITE_FILE(S["feature_flavor_text"]			, features[FEATURE_FLAVOR_TEXT])
	//Custom names
	for(var/custom_name_id in GLOB.preferences_custom_names)
		var/savefile_slot_name = custom_name_id + "_name" //TODO remove this
